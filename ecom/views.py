...
def product_detail_view(request, pk):
    ...
    product=models.Product.objects.get(id=pk)  # Sử dụng get_object_or_404 để xử lý trường hợp sản phẩm không tồn tại
    
    # Xử lý thông tin sản phẩm và tạo ra nội dung cho trang chi tiết sản phẩm
    context = {
        'product': product,
    }
    return render(request, 'ecom/detail_product.html', context)
